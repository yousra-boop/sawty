...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
       ...
       // 3. Insert into `enveloppes` (Completely Anonymous - Pas de lien avec l'utilisateur)
...
// 4. Insert into `votes_logs` (Juste pour vérifier l'unicité et empêcher les votes multiples)
